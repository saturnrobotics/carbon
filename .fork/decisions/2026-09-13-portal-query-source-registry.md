...
**Date:** 2026-09-13
**Scope:** Tasks 03 and 04 of `.fork/plans/2026-09-13-portal-erp-join-repairs.md`.
...
existed. `PORTAL_SOURCES_JSON` appeared in two tests as configuration the
...
- **One configuration input, validated at start-up.** `PORTAL_SOURCES_JSON` is
...
`contrib/deploying/portal/README.md` beside the registry.

## Verification

Recorded in the pull request's verification table. The containerised browser
suite ran as `portal-a4928-registry` on its own ports and image tag and was
