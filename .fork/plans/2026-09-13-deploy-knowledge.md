# Single-command knowledge deployment

Implement `make deploy-knowledge` for the existing manual-v1 Cloud Run release.
...
Verification: `python3 -m unittest discover -s contrib/deploying/knowledge -p
 'test_*.py'`, Ruff, `make -n deploy-knowledge`, and an actual configuration-free
...
untracked and ignored private files. Existing knowledge CI runs the new tests.


Verified: 100 knowledge deployment Python tests, Ruff, changed JSON Biome,
