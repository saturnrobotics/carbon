# Portal connected workflow verification

Approved scope: reconcile the existing portal plans, verify the merged repairs
...
Verification uses the existing `contrib/deploying/portal/build-images.sh e2e`
