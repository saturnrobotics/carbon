...
import * as portalCommandFunctions from "~/modules/portal/portal.mcp.server";
import * as portalFunctions from "~/modules/portal/portal.service";
...
export const functionRegistry = {
  ...
  portal: { ...portalFunctions, ...portalCommandFunctions },
