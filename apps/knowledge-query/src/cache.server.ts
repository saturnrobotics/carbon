...
import {
  ...
  type CacheStore,
  type PolicySnapshot
} from "@carbon/knowledge/cache";
import { currentPolicySnapshot } from "@carbon/knowledge/cache/epochs.server";
import type { withKnowledgeTransaction } from "@carbon/knowledge/database.server";
import type {
  IdentityBinding,
  WorkforceIdentityStore
} from "@carbon/knowledge/identity.server";
import type { EmbeddingConfiguration } from "@carbon/knowledge/query/embedding.server";
import type { VertexConfiguration } from "@carbon/knowledge/query/vertex.server";
import {
  chunkJoins,
  chunkProjection,
  type RetrievedChunk
