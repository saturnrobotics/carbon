import { isDriveSurfaceEnabled } from "@carbon/portal/sources/drive-deployment";
 ...
 * name `PORTAL_DRIVE_ENABLED=true` — every release image — produces a
 ...
 * and `contrib/deploying/portal/compose.local.yaml` for the disposable
 * docker one.
 */
