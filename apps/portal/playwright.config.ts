...
const externalBaseUrl = process.env.PORTAL_E2E_BASE_URL ? baseUrl : undefined;
  ...
  webServer: externalBaseUrl
    ...
    : {
        ...
        env: {
          ...
          PORTAL_E2E_PORTAL_PORT: String(new URL(baseUrl).port || 443),
          PORTAL_WEB_ORIGIN: new URL(baseUrl).origin,
          PORTAL_WORKER_URL:
