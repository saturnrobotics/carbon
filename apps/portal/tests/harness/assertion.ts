...
export const SYNTHETIC_SIGNING_KEY = "portal-e2e-synthetic-signing-key";
export const ASSERTION_COOKIE = "portal_e2e_assertion";
export const ACTOR_COOKIE = "portal_e2e_actor";
