...
def validate(config, secrets):
    if set(config) - CONFIG_KEYS - private_postgres.OPTIONAL_KEYS - payment_sync.CONFIG_KEYS - invoice_inference.CONFIG_KEYS - portal_receiver.CONFIG_KEYS or set(secrets) - SECRET_KEYS - payment_sync.SECRET_KEYS - portal_receiver.SECRET_KEYS:
    ...
    portal_receiver.validate({**config, **secrets})
