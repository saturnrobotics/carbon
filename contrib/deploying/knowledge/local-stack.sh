...
drive_gateway_port=${KNOWLEDGE_PORT_DRIVE_GATEWAY:-4303}
drive_query_port=${KNOWLEDGE_PORT_DRIVE_QUERY:-4304}
...
export KNOWLEDGE_PORT_DRIVE_GATEWAY="$drive_gateway_port"
export KNOWLEDGE_PORT_DRIVE_QUERY="$drive_query_port"
...
start() {
  ...
  wait_http "http://127.0.0.1:$drive_gateway_port/health" 120
  wait_http "http://127.0.0.1:$drive_query_port/health" 120
...
case "${1:-up}" in
  ...
  test)
    ...
    KNOWLEDGE_E2E_DRIVE_GATEWAY_URL="http://127.0.0.1:$drive_gateway_port" \
    KNOWLEDGE_E2E_DRIVE_QUERY_URL="http://127.0.0.1:$drive_query_port" \
