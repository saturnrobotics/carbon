...
variable "probe_image" {
  description = "Digest-pinned synthetic probe image: the bootstrap shell for portal-web and the optional probe service; it has no source credentials or business handlers"
  type        = string
  validation {
