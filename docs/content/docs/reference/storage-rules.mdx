...
<Cards>
  <Card title="Sales rules" href="/docs/reference/sales-rules">
    The sibling rule family: the same condition builder, applied to quote, sales order, and sales invoice
    lines.
  </Card>
