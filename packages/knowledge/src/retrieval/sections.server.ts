 ...
 * base-table policies (client leased through withKnowledgeTransaction "read"),
...
export async function loadParentSections(
  ...
  >(
    `WITH RECURSIVE lineage AS (
      ...
      FROM lineage l JOIN knowledge.chunk p ON p."companyId"=l."companyId" AND p."documentVersionId"=l."documentVersionId"
