 ...
 * read public."user". The connection comes from PORTAL_MIGRATION_DATABASE_URL
 * (the portal_migrate schema login); non-local URLs need --allow-remote and
...
export const DATABASE_URL_VARIABLE = "PORTAL_MIGRATION_DATABASE_URL";
