...
INSERT INTO portal."identityBinding" (id,"companyId","createdBy",issuer,subject,"canonicalUserId",active)
...
FROM portal.document d WHERE d.id IN ('doc-a','doc-hidden','doc-b') ON CONFLICT DO NOTHING;
UPDATE portal.document SET "currentVersionId"='version-'||id,version=version+1
...
UPDATE portal."identityBinding" SET capabilities=ARRAY['portal.read','source.entities.search','kanban.ticket.create'],version=version+1 WHERE "canonicalUserId" IN ('alice','bob');
