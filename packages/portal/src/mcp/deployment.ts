 ...
 * changes:
 *
 * 1. `PORTAL_MCP_ENABLED=true` on the service, and
 ...
 *
 * A third lock sits outside the application: `contrib/deploying/portal/release.py`
 ...
 */
export const MCP_ENABLED_VARIABLE = "PORTAL_MCP_ENABLED";
...
export function isMcpEnabled(
  ...
  const profile =
    environment.PORTAL_RELEASE_PROFILE?.trim() || MANUAL_RELEASE_PROFILE;
