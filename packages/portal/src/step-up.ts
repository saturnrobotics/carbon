 ...
 * portal web can show "sign in to Carbon with two-factor" instead of a
 ...
 * and the portal services' own `{ error: "step_up_required" }`.
 */
...
/** The portal services' response for a step-up denial received from a source. */
