 ...
 * PORTAL_TRUSTED_CALLERS_JSON). Three verdicts, all of which must pass:
 *
 * 1. the runtime zod schema every receiver parses the value with;
 * 2. the published JSON Schema, contrib/deploying/portal/callers.schema.json;
...
export const TRUSTED_CALLERS_SCHEMA_PATH = resolve(
  import.meta.dirname,
  "../../../contrib/deploying/portal/callers.schema.json"
);
